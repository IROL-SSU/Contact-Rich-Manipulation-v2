...
다음 문서인 [Previous Works](./previous_works.md)는 B85를 포함한 비교 대상 11편만으로 구성한 timeline과 공통 six-column 표를 사용해, Ours와 가장 가까운 조건 및 아직 검증되지 않은 C1·C2를 정리한다.
